...
const avatar: string = "/img/avatar.png";
const dribble: string = "/img/dribble.png";
const twitter: string = "/img/twitter.png";
const youtube: string = "/img/youtube.png";
...
export default function Nav() {
  ...
  return (
    <nav className=" relative mx-8 mb-24 flex items-center justify-between pb-6 pt-12 font-medium md:mx-16 lg:mx-32">
      ...
      >
        <a href="/"><img src={avatar} alt="Hua profile picture" /></a>
        <motion.div className="hidden items-center gap-12 xl:flex">
          <a href=""><img src={dribble} alt="Dribble Account" /></a>
          <a href=""><img src={twitter} alt="Twitter Account" /></a>
          <a href=""><img src={youtube} alt="Youtube Channel" /></a>
        </motion.div>
      </motion.div>
      {/* Title */}
